...
- Harden AI collaboration discipline in `code-review`, `dev-planner`, and `CLAUDE.md` with clearer review routing, risk layering, and source-grounded review expectations.
